...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidG9tY2hlbjI5IiwiYSI6ImNrN2sxNnlvZzB6NHkza2xwYjdndW90dm4ifQ.rIFrVWY5aTMNz4yVlYlVBA'; // instantiate mapboxgl, and put the map on the HTML element with id="map"

  var map = new mapboxgl.Map({
    container: 'map',
    // put the map on the HTML element with id="map"
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); // redirect to home page!
...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(name, email, password, passwordConfirm) {
    var res;
        ...
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully")); // once success, refresh the page
...
var stripe = Stripe('pk_test_JMkt7fvBLZP0pP25q12Sc5Qg000WyUjoRe');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('error during payment processing, ', _context.t0);
...
var loginForm = document.querySelector('.form--login'); // the first element in the document with the class ".form--login" is returned

var logOutBtn = document.querySelector('.nav__el--logout');
var signupForm = document.querySelector('.form--signup');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var inputForm = document.querySelector('.form__upload');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData(); // standard web JS library
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordConfirm = document.getElementById('password-confirm').value; // change the HTML text to 'Updating...' to get users some idea of the progress

            document.querySelector('.btn--save-password').textContent = 'Updating...'; // await for server to update the password
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    e.target.textContent = 'Processing...'; // the metadata 'data-tour-id' will be converted into tourId in dataset dict

    (0, _stripe.bookTour)(e.target.dataset.tourId);
  });
}
